...
global.owner = process.env.OWNER_NUMBER  || '2348086051695' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=LYsxTICL#4gHqecgYtfChK9awYoA8wOQTbyuqU0-sg2mQro8BAWM' ,
